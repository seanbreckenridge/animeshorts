...
Currently, the site only links to MAL, but I left the yaml and python files relatively open, so if someone wants to contribute (i.e. add AniList ([API example](https://gist.github.com/purplepinapples/5dc60f15f2837bf1cea71b089cfeaa0a))), create an issue and I'm happy to work with ya.
